...
Vibecoding Signal Light 是一个 macOS 原生交通灯工具，将 Codex、Codex 等本地 AI Agent 的状态以悬浮窗、菜单栏图标和 Touch Bar 的形式可视化展示。
...
| SignalLightCLI | `HookParsing.swift` | Swift 版 hook 解析（功能与 Python codex/Codex hook 对等） |
